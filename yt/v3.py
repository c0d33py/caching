...
class YouTubeAPIClient:
    def __init__(
        ...
        self.cache = TTLCache(maxsize=100, ttl=cache_expiry)
        self.youtube = None
        self._init_client()
    ...
    def _request(self, method, *args, **kwargs):
        ...
        if response:
            ...
            raise RetryError("Request failed.")

    def _get_from_cache_or_request(self, func, *args, **kwargs):
        cache_key = (func.__name__, frozenset(args), frozenset(kwargs.items()))
    ...
    def search_videos(self, query, max_results=5):
        return self._get_from_cache_or_request(
            self._search_videos, query, max_results=max_results
        )
    ...
    def get_video_details(self, video_id):
        return self._get_from_cache_or_request(self._get_video_details, video_id)
